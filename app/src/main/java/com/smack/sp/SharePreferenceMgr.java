...
public class SharePreferenceMgr {
    ...
    public static final String KEY_OFUSERNAME = "ofUserName";
    public static final String KEY_OFPASSWORD = "ofPassWord";
    ...
    public static void putImage(Context mContext, String key, ImageView imageView) {
        ...
        // 将String保存shareUtils
        SharePreferenceMgr.put(mContext, key, imgString);
    }
    ...
    public static Bitmap getImage(Context mContext, String key, ImageView imageView) {
        String imgString = (String) SharePreferenceMgr.get(mContext, key, "");
        if (!imgString.equals("")) {
            // 利用Base64将我们string转换
